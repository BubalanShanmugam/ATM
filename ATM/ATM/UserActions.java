...
import java.lang.String;
    ...
    public class UserActions {
        ...
        public static User userLogin(Scanner sc, AdminActions adminActions) throws CloneNotSupportedException {
        ...
        public void deposit(double amount, Scanner sc,User user) {
            ...
            if(amount==total){
                ...
                user.getTransactionHistory(user.getTransactionHistory()).add(new Transfer(user.getUsername(), "Deposit", amount));
            }
            else{
        ...
        public void viewTransactionHistory(User user) {
            ArrayList<Transfer> transactionHistory = user.getTransactionHistory(ATM.getTransactionHistory());
        ...
        public void addTransaction(Transfer transfer,ArrayList<Transfer> transactionHistory ){
